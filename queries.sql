...
SELECT count(*) FROM FactCurrencyRate;
SELECT count(*) FROM FactInternetSales;
SELECT count(*) FROM FactInternetSalesReason;
SELECT count(*) FROM FactSurveyResponse;
SELECT count(*) FROM DimReseller;
